...
{
	public partial class CPU_Priority_UC : UserControl
	{
		...
		private void ProDGV_CellClick(object sender, DataGridViewCellEventArgs e)
		{
			...
			numPriority.Value = SelectedProcess.Priority;
		}
		...
		private void BtnEdit_Click(object sender, EventArgs e)
		{
			...
			SelectedProcess.Priority = Convert.ToInt32(numPriority.Value);
		...
		private void BtnStartScheduling_Click(object sender, EventArgs e)
		{
			...
			var priority = new CPU_Priority_Algorithm(Processes, TglAscending.ToggleState == ToggleButtonState.Inactive ? true : false);
			...
			TerminatedProcess = priority.TerminatedProcesses;
		...
		private void BtnReset_Click(object sender, EventArgs e)
		{
			...
			TglAscending.ToggleState = ToggleButtonState.Inactive;
